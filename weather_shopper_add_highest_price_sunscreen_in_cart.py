"""
To add only the highest price sunscreen in cart.
"""
...
time.sleep(10)
driver.find_element_by_xpath("button [@class="btn btn-primary" ] [@onclick="addToCart('%s',%d)'"]%(max_product,max_prize)).click()
